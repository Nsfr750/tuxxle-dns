...
class Translations:
    ...
    def _initialize_translations(self) -> None:
        ...
        self.translations_data['es'] = {
            ...
            # DNS Records
            'dns.record.add': 'Adicionar Registro DNS',
            'dns.record.edit': 'Editar Registro DNS',
            'dns.record.delete': 'Excluir Registro DNS',
            'dns.record.type.a': 'Registro A',
            'dns.record.type.aaaa': 'Registro AAAA',
            'dns.record.type.cname': 'Registro CNAME',
            'dns.record.type.mx': 'Registro MX',
            'dns.record.type.txt': 'Registro TXT',
            'dns.record.type.ns': 'Registro NS',
            'dns.record.type.soa': 'Registro SOA',
            'dns.record.type.ptr': 'Registro PTR',
            'dns.record.type.srv': 'Registro SRV',
